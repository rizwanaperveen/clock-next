...
export default function DigitalClockComponent() {
  ...
  return (
    <div className="flex items-center justify-center h-screen border-l-indigo bg-indigo-400">
      
      {/* Center the digital clock within the screen */}
      <Card className="p-8 shadow-lg rounded-2xl bg-indigo-200">
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="mt-4 flex items-center">
            <Button
              ...
              className="mr-2 font-bold bg-red-300"
            >
              24-Hour Format
            </Button>
            <Button
